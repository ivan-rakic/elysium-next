...
class Workshops extends Component {
    render() {
        return (
            <div>
                <Head>
                    <title>Workshops - Elysium Island Festival 2020</title>
                    <meta title="description" content="Join us on the transformational experience... Check out the festival workshops." />
                </Head>
                <NextSeo
                    openGraph={{
                        type: 'website',
                        url: 'http://www.elysiumislandfestival.com/program/healing-workshop.html',
                        title: 'Workshops - Elysium Island Festival 2020',
                        description: 'Join us on the transformational experience... Check out the festival workshops.',
                        images: [
                            {
