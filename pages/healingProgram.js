...
class Workshops extends Component {
    render() {
        return (
            <div>
                <Head>
                    <title>Healing Program - Elysium Island Festival 2020</title>
                    <meta title="description" content="Join us on the transformational experience... Check out the healing program." />
                </Head>
                <NextSeo
                    openGraph={{
                        type: 'website',
                        url: 'http://www.elysiumislandfestival.com/healing-program.html',
                        title: 'Healing Program - Elysium Island Festival 2020',
                        description: 'Join us on the transformational experience... Check out the healing program.',
                        images: [
                            {
